...
- **Web UI — Voice:** Click "Capture" in the top bar → Voice tab → record → stop. WatsonxAI processes and shows which notes were created or updated.
...
- **What WatsonxAI does with your dump:** Deduplicates against existing notes, links related concepts, splits multi-concept dumps into atomic notes, flags contradictions with existing knowledge.
