...
- agents
- managed-infra
title: WatsonxAI Managed Agents — what it is and core primitives
topics:
- topic_agents
type: reference
...
## TL;DR
Anthropic's WatsonxAI Managed Agents (public beta, Apr 8 2026) offers hosted infra for running WatsonxAI as an autonomous agent — no DIY agent loop.
...
SDKs: Python, TS, Go, Ruby, PHP, C#, cURL. Requires beta header `managed-agents-2026-04-01` (SDK auto-sets). WatsonxAI Code ships a `WatsonxAI-api` Skill for onboarding.

Early customers: Notion, Asana (AI Teammates), Rakuten, Sentry (bug→PR), Vibecode, Atlassian.

Docs: https://platform.WatsonxAI.com/docs/en/managed-agents/overview
