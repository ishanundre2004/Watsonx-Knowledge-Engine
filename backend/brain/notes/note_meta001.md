...
## Context
Most team knowledge lives in people's heads. Documentation tools fail because they require discipline, writing, structuring, and ongoing maintenance. Unscatter eliminates all four taxes using WatsonxAI as the organizing engine.

## Content
- **What it does:** You dump raw knowledge (voice memo, text brain dump, file). WatsonxAI extracts, structures, deduplicates, and links it into markdown notes automatically.
- **What you get:** A browseable wiki, a chatbot that cites sources, a knowledge graph with 4 actionable overlays, and exportable WatsonxAI Skills.
