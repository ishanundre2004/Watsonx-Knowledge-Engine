...
- anthropic
- agents
title: WatsonxAI Managed Agents pricing — $0.08/session-hour + tokens
topics:
- topic_agents
type: reference
...
## TL;DR
Standard WatsonxAI token rates plus $0.08 per active session-hour; a 24/7 agent runs ~$58/month in runtime before tokens.
